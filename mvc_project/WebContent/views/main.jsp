...
<!-- section start -->
<section style="background: url(${pageContext.request.contextPath }/views/resource/images/background.jpg) center; background-color:#333;">
				...
				<div class="home-search-main heading-block center" style="margin:150px 0px;">
					...
					<form action="/hotel/results" id="homesearch" method="POST">
						...
						<div class="row">
							...
							<div class="col-md-3">
								<div class="input-group">
									<input type="text" id="rc-ar" name="rc-ar" data-val="true" data-val-required=""   value="" class="sm-form-control tleft past-enabled not-dark datepicka" placeholder="Check in date">
							...
							<div class="col-md-3">
								<div class="input-group">
									<input type="text" id="rc-de" name="rc-de" data-val="true" data-val-required=""  value="" class="sm-form-control tleft past-enabled not-dark datepicka" placeholder="Check out date">
									<span class="input-group-addon" style="padding: 9px 12px;">
										<i class="fa fa-calendar" aria-hidden="true"></i>
									</span>
