...
<script type="text/javascript" src="${pageContext.request.contextPath }/SE2/workspace/js/service/HuskyEZCreator.js" charset="utf-8"></script>
<style>
	.page-header{
		margin-top: 0;
		border-bottom: 0px;
...
<script type="text/javascript">
	...
	nhn.husky.EZCreator.createInIFrame({
		...
		sSkinURI : "${pageContext.request.contextPath }/SE2/dist/SmartEditor2Skin.html",
		htParams : {
